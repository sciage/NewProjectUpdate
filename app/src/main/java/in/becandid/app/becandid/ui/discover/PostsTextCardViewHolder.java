...
public abstract class PostsTextCardViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
  ...
  protected ImageView  user_avatar;
    ...
    protected ImageView image_last_comment_text;
  ...
  protected TextView new_counter_like_number;
    ...
    protected ImageView likeButtonMain;
    ...
    @BindView(R.id.candid_back_text)
    protected ConstraintLayout candid_back_text;

    @BindView(R.id.textstatusback)
    protected RelativeLayout textstatusback;
    ...
    public PostsTextCardViewHolder(View itemView, Context context) {
        ...
        candid_back_text.setVisibility(View.GONE);
    ...
    protected void textshare(View view) {
    ...
    public void bind(PostsModel dataItem) {
        ...
        if (dataItem.getLast_message_avatar()==null){
            llCommentViews_text.setVisibility(View.GONE);
        } else {
            llCommentViews_text.setVisibility(View.VISIBLE);
            llCommentViews_text.setBackgroundColor(Color.parseColor(dataItem.getDark_color()));
            candid_back_text.setBackgroundColor(Color.parseColor(dataItem.getDark_color()));

            tvAllComments_text.setText("Read All " + String.valueOf(dataItem.getComments() + dataItem.getComments_reply()) + " comments");
            Glide.with(itemView.getContext()).asDrawable()
                    .load(dataItem.getLast_message_avatar())
                    .error(R.drawable.user)
                    .placeholder(R.drawable.user)
                    .into(image_last_comment_text);

            tvLastComment_text.setText(dataItem.getLast_message());
      ...
      /*  if (!checkPermissions()){
        ...
        */
        ...
        Glide.with(itemView.getContext()).asDrawable()
                .load(dataItem.getAvatar_url_random())
                .error(R.drawable.user)
                .placeholder(R.drawable.user)
                .into(user_avatar);
