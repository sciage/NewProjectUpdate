...
public final class ApiEndPoint {
    ...
    public static final String POST_IMAGE_UPLOAD =   "php-storage-3-new/uploadImage.php";


    public static final String POST_IMAGE_UPLOAD_WITHOUT_FILTER =   "php-storage-3-new/upload02.php";
