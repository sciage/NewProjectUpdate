...
import in.becandid.app.becandid.retrofit.ANError;
...
public class DiscoverHistoryPresenter <V extends DiscoverHistoryMvpView> extends BasePresenter<V>
    ...
    @Override
    public void getHistoryPostsOnline(String id_user_name, String interaction, int page) {
        //    getMvpView().showLoading();
        getCompositeDisposable().add(getDataManager()
                .getHistoryPosts(id_user_name, interaction,String.valueOf(page))
    ...
    @Override
    public void getHistoryPostsOnline02(String id_user_name, String interaction, int page) {
        //  getMvpView().showLoading();
        getCompositeDisposable().add(getDataManager()
                .getHistoryPosts(id_user_name, interaction,String.valueOf(page))
                .subscribeOn(getSchedulerProvider().io())
