...
public class CommentReplyAdapter extends RecyclerView.Adapter<CommentReplyAdapter.ReplyMessageViewHolder> {
    ...
    class ReplyMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView comment_reply_image;
        ...
        public ReplyMessageViewHolder(final View itemView, RxBus bus) {
            ...
            userImage = (ImageView) itemView.findViewById(R.id.iv_user_image_reply);
            comment_reply_image = (ImageView) itemView.findViewById(R.id.comment_reply_image);
        ...
        /*    messageCard.setOnClickListener(new View.OnClickListener() {
            ...
            username.setTextColor(Color.parseColor(messageItem.getRandom_color_light()));
         ...
         //   userImage.getHierarchy().setRoundingParams(roundingParams);
            ...
            userImage.setBackgroundColor(Color.parseColor(messageItem.getRandom_color_light()));
