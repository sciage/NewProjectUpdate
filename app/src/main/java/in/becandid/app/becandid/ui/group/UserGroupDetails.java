...
public class UserGroupDetails extends BaseActivity implements OnLoadMoreListener, View.OnClickListener, UserGroupMvpView {
    ...
    ImageView category_back_image;
    ImageView category_back_image_icon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        category_back_image = (ImageView)findViewById(R.id.category_back_image);
        category_back_image_icon = (ImageView)findViewById(R.id.category_back_image_icon);
    ...
    private void setTextViewParameters(CommunityGroupPojo response){
        ...
        Glide.with(UserGroupDetails.this).asDrawable()
                .load(response.getGroupImageUrl())
                .error(R.drawable.image)
                .placeholder(R.drawable.image)
                .into(category_back_image);
