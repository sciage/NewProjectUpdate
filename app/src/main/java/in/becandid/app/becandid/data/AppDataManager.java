...
public class AppDataManager implements DataManager {
    ...
    */
    ...
    @Override
    public Single<List<PostsModel>> getHistoryPosts(String id_user_name, String group_post, String page) {
        return mApiHelper.getHistoryPosts(id_user_name,  group_post, page);
    }
    ...
    public Single<List<PostsModel>> getLatestPosts(String user_id, String latest, String page) {
        return mApiHelper.getLatestPosts(user_id, latest, page);
    }

    @Override
    public Single<List<PostsModel>> getSingleUserPosts(String id_user, String singleuser, String page) {
        return mApiHelper.getSingleUserPosts(id_user, singleuser, page);
    }
