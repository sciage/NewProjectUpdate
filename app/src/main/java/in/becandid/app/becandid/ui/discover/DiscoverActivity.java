...
public class DiscoverActivity extends BaseActivity implements Constants, DiscoverActivityMvpView {
    ...
    protected void onCreate(Bundle savedState) {
      ...
      //  installCertificate(this);
       ...
       // String deviceToken = FirebaseInstanceId.getInstance().generatetoken();
                  ...
                  //  postFirebaseToken(MySharedPreferences.getFireBaseToken(preferences));
                    ...
                    FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener( DiscoverActivity.this,  new OnSuccessListener<InstanceIdResult>() {
                        ...
                        public void onSuccess(InstanceIdResult instanceIdResult) {
                            String newToken = instanceIdResult.generatetoken();
 ...
 navigation = (BottomNavigationView) findViewById(R.id.navigation);
        ...
        FirebaseInstanceId.getInstance().getInstanceId()
                .addOnCompleteListener(new OnCompleteListener<InstanceIdResult>() {
                    ...
                    public void onComplete(@NonNull Task<InstanceIdResult> task) {
                        ...
                        if (MySharedPreferences.getFireBaseToken(preferences)==null){
                            MySharedPreferences.registerFirebaseToken(preferences, token);
                            mPresenter.postSaveToken(MySharedPreferences.getUserId(preferences), token);
                        }
    ...
    private void shareScreenshot(File uri) {
        ...
        Uri photoURI = FileProvider.getUriForFile(DiscoverActivity.this,
