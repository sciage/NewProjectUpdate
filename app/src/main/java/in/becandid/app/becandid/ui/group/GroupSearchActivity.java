...
public class GroupSearchActivity extends BaseActivity implements GroupSearchMvpView {
    ...
    @BindView(R.id.search_groups_new) protected EditText search_groups;
    @BindView(R.id.search_button_group) protected TextView search_button_group;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_button_group.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GroupSearchActivity.this, SearchActivity.class);
                intent.putExtra(Constants.SEARCH_QUERY, search_groups.getText().toString());
                startActivity(intent);

                search_groups.getText().clear();
            }
        });
    }
