...
//    @SerializedName("user_Listen") @Expose private Boolean userListen;
    ...
    @SerializedName("last_message") @Expose private String last_message;
    @SerializedName("last_message_avatar") @Expose private String last_message_avatar;

    public String getLast_message() {
        return last_message;
    }

    public String getLast_message_avatar() {
        return last_message_avatar;
    }
