...
public class EditGroupActivity extends BaseActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener, EditGroupMvpView {
    ...
    private Spinner spinner_category_edit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivProfileImage_edit = (ImageView) findViewById(R.id.ivProfileImage_edit);
        ...
        spinner_category_edit = (Spinner) findViewById(R.id.spinner_category_edit);
        ...
        spinner_category_edit.setAdapter(adapter);
    ...
    public void getGroupSpecific(List<CommunityGroupPojo> response) {
        ...
        Glide.with(EditGroupActivity.this).asDrawable()
                .load(response.get(0).getGroupImageUrl())
                .error(R.drawable.user)
                .placeholder(R.drawable.user)
                .into(ivProfileImage_edit);

      //  ivProfileImage_edit.setImageURI(response.get(0).getGroupImageUrl());

        spinner_category_edit.setSelection(getIndex(spinner_category_edit, response.get(0).getIdCategories()));
