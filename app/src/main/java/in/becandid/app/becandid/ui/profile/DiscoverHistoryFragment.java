            ...
            public void onRefresh() {
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            mPresenter.getHistoryPostsOnline(MySharedPreferences.getUserId(preferences),"true", currentPage);
    ...
    public void onLoadMore() {
        if (response.size() == 25){
            try {
                ...
                currentPage += 1;
                mPresenter.getHistoryPostsOnline02(MySharedPreferences.getUserId(preferences),"true", currentPage);
