...
public class SwipeStackAdapterFinal extends BaseAdapter {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        imageView = (ImageView) view.findViewById(R.id.community_group_image);
        ...
        if (mData.get(position).getGroupImageUrl() != null){
           // Glide.with(view.getContext()).load(mData.get(position).getGroupImageUrl()).into(imageView);
            ...
            Glide.with(imageView.getContext()).asDrawable()
                    .load(mData.get(position).getGroupImageUrl())
                    .error(R.color.md_grey_600)
                    .placeholder(R.color.md_grey_600)
                    .into(imageView);
