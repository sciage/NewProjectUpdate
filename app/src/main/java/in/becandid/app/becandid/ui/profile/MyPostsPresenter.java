...
public class MyPostsPresenter <V extends MyPostsMvpView> extends BasePresenter<V>
    ...
    @Override
    public void getSingleUserPostsOnline(String id_user, String singleuser, int page) {
        // getMvpView().showLoading();
        getCompositeDisposable().add(getDataManager()
                .getSingleUserPosts(id_user, singleuser, String.valueOf(page))
    ...
    @Override
    public void getSingleUserPostsOnline02(String id_user, String singleuser, int page) {
        //  getMvpView().showLoading();
        getCompositeDisposable().add(getDataManager()
                .getSingleUserPosts(id_user, singleuser, String.valueOf(page))
                .subscribeOn(getSchedulerProvider().io())
