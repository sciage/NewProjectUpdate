...
public interface DiscoverHistoryMvpPresenter <V extends DiscoverHistoryMvpView> extends MvpPresenter<V>{
    ...
    void getHistoryPostsOnline(String id_user_name, String interaction, int page);
    void getHistoryPostsOnline02(String id_user_name, String interaction, int page);
