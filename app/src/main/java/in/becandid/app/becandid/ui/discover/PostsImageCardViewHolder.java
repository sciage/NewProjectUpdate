...
public abstract class PostsImageCardViewHolder extends BaseViewHolder implements View.OnClickListener, MvpView {
    ...
    protected ImageView image_last_comment_image;
    ...
    protected ImageView list_item_posts_message_image;
   ...
   /* protected void sameButtonMethod(View view) {
    ...
    public void bind(PostsModel dataItem) {
        ...
        if (dataItem.getLast_message_avatar()==null){
            llCommentViews_image.setVisibility(View.GONE);
        } else {
            llCommentViews_image.setVisibility(View.VISIBLE);

            llCommentViews_image.setBackgroundColor(Color.parseColor(dataItem.getDark_color()));

            tvAllComments_image.setText("Read All " + String.valueOf(dataItem.getComments() + dataItem.getComments_reply()) + " comments");
            Glide.with(itemView.getContext()).asDrawable()
                    .load(dataItem.getLast_message_avatar())
                    .error(R.drawable.user)
                    .placeholder(R.drawable.user)
                    .into(image_last_comment_image);
            tvLastComment_image.setText(dataItem.getLast_message());
        ...
        if (key_adult_filter){
            if (dataItem.isAdult_filter()){
                ...
                Glide.with(itemView.getContext()).asDrawable()
                        .load(dataItem.getImage_url())
                        .error(R.drawable.picture)
                        .placeholder(R.drawable.picture)
                        .into(list_item_posts_message_image);
