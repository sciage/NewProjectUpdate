...
public class PostUserCommentModel implements Parcelable {
    ...
    @SerializedName("random_color_dark") @Expose private String random_color_dark;
    @SerializedName("random_color_light") @Expose private String random_color_light;

    public String getRandom_color_dark() {
        return random_color_dark;
    }

    public String getRandom_color_light() {
        return random_color_light;
    }
