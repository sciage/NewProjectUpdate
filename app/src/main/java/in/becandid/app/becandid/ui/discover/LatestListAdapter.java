...
public class LatestListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
   ...
   // private PostsModel postsModel;
    ...
    private ShareInterface listener;
...
//        this.listener = shareInterface;
    ...
    public LatestListAdapter(Context context, ShareInterface shareInterface) {
        this.mContext = context;
        dataSet = new ArrayList<>();
        this.listener = shareInterface;
 ...
 /*   @Override
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case PostsModel.TEXT_TYPE:
                ...
                return new TextTypeViewHolderText(view, mContext, listener);
            case PostsModel.IMAGE_TYPE:
   ...
   /* @Override
    ...
    public static class TextTypeViewHolderText extends PostsTextCardViewHolder implements PixelShot.PixelShotListener {
    ...
    //    private boolean doDislike;
        ...
        public TextTypeViewHolderText(View itemView, Context context, ShareInterface listener) {
      ...
      //          return;
            ...
            candid_back_text.setVisibility(View.VISIBLE);
        ...
        private void shareImage(View view) {
          //  progressFrame.setVisibility(View.VISIBLE);
            ...
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    if (ActivityUtils.delete_perm(view.getContext(), 6432)){
                        // shareStatus = true;
                        PixelShot.of(textstatusback).setResultListener(TextTypeViewHolderText.this).toPNG().save();
        ...
        private void askPermissions(View view) {
            int requestCode = 232;
            String[] permissions = {Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA};
            for (String permission : permissions) {
                if (ContextCompat.checkSelfPermission(view.getContext(), permission) != PermissionChecker.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions((Activity)view.getContext(), permissions, requestCode);
                }
            }
        }
