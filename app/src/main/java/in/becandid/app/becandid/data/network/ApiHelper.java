...
public interface ApiHelper {
   ...
   // Single<SuccessResponse> postCommentReplyLike(String id_post_comment_reply, String id_user_name, String likes, String post_comment_reply_id, String user_id, String token);
    ...
    // get history posts
    Single<List<PostsModel>> getHistoryPosts(String id_user_name, String interaction, String page);

    Single<SuccessResponse> get_group_name_check(String group_name);
    // get latest posts
    Single<List<PostsModel>> getLatestPosts(String user_id, String latest, String page);


    // get single user posts
    Single<List<PostsModel>> getSingleUserPosts(String id_user, String singleuser, String page);
